...
feature {NONE} -- Initialization
	...
	initialize
		...
		do
			...
			set_service_option ("max_concurrent_connections", 500)
		end

feature -- Basic operations

	execution (req: WSF_REQUEST; res: WSF_RESPONSE): separate APPLICATION_REQUEST_EXECUTION
		do
			create Result.make (req, res)
		end
