...
feature {NONE} -- Initialization
	...
	make (a_request_settings: HTTPD_REQUEST_SETTINGS)
		do
			...
			timeout_ns := seconds_to_nanoseconds (a_request_settings.timeout) -- nanoseconds
			socket_recv_timeout_ns := seconds_to_nanoseconds (a_request_settings.socket_recv_timeout) -- nanoseconds
			keep_alive_timeout_ns := seconds_to_nanoseconds (a_request_settings.keep_alive_timeout) -- nanoseconds
...
feature -- Parsing
	...
	get_request_header (a_socket: HTTPD_STREAM_SOCKET; a_is_reusing_connection: BOOLEAN)
		...
		do
			...
			then
				if a_is_reusing_connection then
					a_socket.set_recv_timeout_ns (keep_alive_timeout_ns) -- in seconds!
				else
